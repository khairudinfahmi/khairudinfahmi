...
### [E-commerce Bulk Promo Automation & Audit](https://github.com/khairudinfahmi/ecommerce-bulk-promo-tool)
* **Problem**: Setting mass promotions manually across TikTok Shop and Shopee is error-prone. A single typing mistake (e.g. misplaced decimals) can cause immediate financial loss if underpriced items are purchased in bulk before correction.
* **Solution**: Developed a Python desktop tool that automates discount configurations across databases and runs a safety net audit (checking minimum/maximum price thresholds) before uploading, completely eliminating pricing errors.
