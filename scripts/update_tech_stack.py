...
def main():
    ...
    icons_str_encoded = "%2C".join(sorted_icons)
    ...
    replacement = (
        ...
        f'    <picture>\n'
        f'      <source media="(prefers-color-scheme: dark)" srcset="https://skillicons.dev/icons?i={icons_str_encoded}&perline=8&theme=dark" />\n'
        f'      <source media="(prefers-color-scheme: light)" srcset="https://skillicons.dev/icons?i={icons_str_encoded}&perline=8&theme=light" />\n'
        f'      <img src="https://skillicons.dev/icons?i={icons_str}&perline=8&theme=dark" alt="Fahmi\'s Tech Stack" />\n'
        f'    </picture>\n'
        f'  </a>\n'
        f'</p>\n'
        f'<!-- TECH-STACK-LIST:END -->'
    )
